...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default='/media/ubuntu/G/dataset_KITTI/data_32_velodyne_clear/dataset',
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default='config/labels/semantic-kitti-32to4-cn-homedecay.yaml',
